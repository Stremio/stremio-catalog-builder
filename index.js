	...
	$("#submitButton").click(function() {
		...
		$.ajax({
			...
			success: function(data) {
				if (data) {
					if (data.collection) {
						$("#pageContent").html('<br/><br/><h2>Press to load new catalogs in Stremio:</h2><a id="catalogButton" class="button" href="stremio://catalog-backend.baby-supernode.xyz/'+data.collection+'/grouped.json">Load Catalogs</a><br/><br/>This button will expire in 1 hour.')
						setTimeout(function() {
